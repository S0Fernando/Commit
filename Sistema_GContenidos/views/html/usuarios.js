...
function cargarUsuarios() {
    ...
    xhr.open("GET", "../controllers/usuarios.controllers.php", true);
...
document.getElementById("formUsuario").onsubmit = function(event) {
    ...
    var xhr = new XMLHttpRequest();
    if (id_usuario) {
        xhr.open("PUT", "../controllers/usuarios.controllers.php", true);
    } else {
        xhr.open("POST", "../controllers/usuarios.controllers.php", true);
    }
...
function eliminarUsuario(id_usuario) {
    if (confirm("¿Está seguro de eliminar este usuario?")) {
        var xhr = new XMLHttpRequest();
        xhr.open("DELETE", "../controllers/usuarios.controllers.php", true);
        xhr.setRequestHeader("Content-Type", "application/json");
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                cargarUsuarios();
